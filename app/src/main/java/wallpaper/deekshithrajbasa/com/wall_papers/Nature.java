...
public class Nature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //firebase
        myref = FirebaseDatabase.getInstance().getReference().child("/nature");
        FirebaseRecyclerAdapter<instagramAdapter,Nature.BlogViewHolder> recyclerAdapter = new FirebaseRecyclerAdapter<instagramAdapter, Nature.BlogViewHolder>(
                instagramAdapter.class,
                R.layout.individual_row,
                Nature.BlogViewHolder.class,
                myref
        )
        {
            @Override
            protected void populateViewHolder(Nature.BlogViewHolder viewHolder, instagramAdapter model, int position) {
